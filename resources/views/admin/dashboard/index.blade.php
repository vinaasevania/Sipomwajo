                            ...
                            <div class="card-body pb-3">
                                <div class="flex-grow-1">
                                    ...
                                    <div class="symbol symbol-50 pb-3">
                                        <span class="symbol">
                                            <img src="{{ asset('assets/media/svg/misc/IC-Totalormas.svg')}}"
                        ...
                        <div class="card card-custom card-stretch gutter-b">
                            ...
                            <div class="card-body pb-3">
                                <div class="flex-grow-1">
                                    ...
                                    <div class="symbol symbol-50 pb-3">
                                        <span class="symbol">
                                            <img src="{{ asset('assets/media/svg/misc/ic-totalpermohonan.svg')}}"
                                                class="h-50 align-self-center" alt="" />
                                        </span>
                                    </div>
                        ...
                        <div class="card card-custom card-stretch gutter-b">
                            ...
                            <div class="card-body pb-3">
                                <div class="flex-grow-1">
                                    ...
                                    <div class="symbol symbol-50 pb-3">
                                        <span class="symbol">
                                            <img src="{{ asset('assets/media/svg/misc/ic-totalperdana.svg')}}"
                                                class="h-50 align-self-center" alt="" />
                                        </span>
                                    </div>
                        ...
                        <div class="card card-custom card-stretch gutter-b">
                            ...
                            <div class="card-body pb-3">
                                <div class="flex-grow-1">
                                    <div class="symbol symbol-50 pb-3">
                                        <span class="symbol">
                                            <img src="{{ asset('assets/media/svg/misc/ic-totalpelaporan.svg')}}"
                                                class="h-50 align-self-center" alt="" />
                                        </span>
                                    </div>
