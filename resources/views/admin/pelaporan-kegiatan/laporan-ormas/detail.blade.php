                            ...
                            <div class="row mt-6">
                                <div class="col-md-6 mb-3">
                                    <div class="d-flex align-items-center border col bg-white px-6 py-4 rounded mr-7">
                                        ...
                                        <!--begin::Buttonpreview-->
                                        <a target="_blank"
                                            href="{{ secure_asset('storage/laporanKegiatan/' . $laporanOrmas->laporan_kegiatan) }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="d-flex align-items-center border col bg-white px-6 py-4 rounded">
                                        ...
                                        <!--begin::Buttonpreview-->
                                        <a target="_blank"
                                            href="{{ secure_asset('storage/fotoKegiatan/' . $laporanOrmas->foto_kegiatan1) }}"
                                            class="btn btn-outline-primary font-weight-bold px-4 py-2">Preview</a>
                                        <!--end::Buttonpreview-->
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="d-flex align-items-center border col bg-white px-6 py-4 rounded">
                                        ...
                                        <!--begin::Buttonpreview-->
                                        <a target="_blank"
                                            href="{{ secure_asset('storage/fotoKegiatan/' . $laporanOrmas->foto_kegiatan2) }}"
                                            class="btn btn-outline-primary font-weight-bold px-4 py-2">Preview</a>
                                        <!--end::Buttonpreview-->
                                    </div>
                                </div>
                                @if ($laporanOrmas->foto_kegiatan3 != null)
                                    <div class="col-md-6 mb-3">
                                        <div class="d-flex align-items-center border col bg-white px-6 py-4 rounded">
                                            ...
                                            <!--begin::Buttonpreview-->
                                            <a target="_blank"
                                                href="{{ secure_asset('storage/fotoKegiatan/' . $laporanOrmas->foto_kegiatan3) }}"
                                                class="btn btn-outline-primary font-weight-bold px-4 py-2">Preview</a>
                                            <!--end::Buttonpreview-->
                                        </div>
                                    </div>
